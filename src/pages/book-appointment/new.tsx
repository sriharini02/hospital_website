...
import { FaCalendarAlt, FaClock, FaUser, FaPhone, FaEnvelope, FaHospital, FaStethoscope } from 'react-icons/fa';
...
const doctors: DoctorsByDepartment = {
  ...
  'General Medicine': ['Dr. Anil Gupta', 'Dr. Sunita Reddy'],
  'Gynecology': ['Dr. Priya Malhotra', 'Dr. Nandini Sharma']
};
...
export default function BookAppointment() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Book an Appointment | LifeCare Hospital</title>
